...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BOUNSWEET  : SPECIES_BOUNSWEET)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_MAGBY : SPECIES_MAGBY)
#define WATER_STARTER (IS_FRLG ? SPECIES_HORSEA   : SPECIES_HORSEA)
